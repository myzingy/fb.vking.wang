...
END;
    ...
    function getFBAccounts($user){
        ...
        $res=$fb->get($user->id.'/adaccounts?fields=account_id,name',$user->long_token);
...
//            ))->delete();
    ...
    function FBC($ac_id=""){
        ...
        if($ac_id){
            $mod->field('UA.account_id,UA.account_name,U.long_token as access_tokens,CONCAT(\'act_\',UA.account_id) as act_id,UA.utc_seconds');
